...
public class MainClass08 {
	public static void main(String[] args) {
		...
		//위 문자열에서 mimi 라는 문자열을 mama 라는 문자열로 교체 해서 결과를 greet2에 담아 보세요
		//단,String 객체의 메소드를 활용해서
		String greet2=greet.replace("mimi", "mama");
		
		String message="My name is kimgura";
		/*
		 * 1. 위의 문자열이 My 라는 문자열로 시작 하는지 여부(true or false)를 isStart라는 변수에 담아보세요
		 * 
		 * 2. 위의 문자열이 i 가 문자열의 몇번째 인덱스에 위치하고 있는지 index 라는 변수에 담아보세요.
		 */
